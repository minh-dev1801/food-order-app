  ...
  return (
    <>
      ...
      <main className="mx-auto my-0 w-[90%] max-w-[40rem] text-center">
        <h2 className="text-montserrat text-4xl text-[#ddd6cb]">Community Perks</h2>
        ...
        <ul className="my-8">
          <li className="flex flex-col items-center gap-4">
            ...
            />
            <p className="text-montserrat text-[#ddd6cb]">Share & discover recipes</p>
          </li>
          ...
          <li className="flex flex-col items-center gap-4">
            ...
            />
            <p className="text-montserrat text-[#ddd6cb]">Find new friends & like-minded people</p>
          </li>
          ...
          <li className="flex flex-col items-center gap-4">
            ...
            />
            <p className="text-montserrat text-[#ddd6cb]">Participate in exclusive events</p>
          </li>
        </ul>
      </main>
    </>
